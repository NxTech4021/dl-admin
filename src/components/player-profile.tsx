                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold flex items-center gap-3">
                      <Link href={`/league/view/${league.id}`} className="hover:underline">
                        {league.name}
                      </Link>
                    </h4>
                    <p className="text-sm text-muted-foreground">
                    ...
                    <div className="flex items-center gap-4 text-xs text-muted-foreground mt-1">
                      <span>Joined {new Date(league.membership.joinedAt).toLocaleDateString()}</span>
              ...
              <div key={season.id} className="flex items-center justify-between p-4 border rounded-lg">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      <Link href={`/league/view/${season.category.league.id}`} className="hover:underline">
                        {season.category.league.name}
                      </Link>
                       • {season.category.league.sportType}
                    </p>
                    <div className="flex items-center gap-4 text-xs text-muted-foreground mt-1">
                      <span>Joined {new Date(season.membership.joinedAt).toLocaleDateString()}</span>
                      <span>
                        Division: {season.membership.division?.id ? (
                          <Link href={`/league/divisions/${season.membership.division.id}`} className="hover:underline">
                ...
                <div className="text-right">
                  <Badge variant={season.status === 'ACTIVE' ? 'default' : season.status === 'FINISHED' ? 'secondary' : 'outline'}>
                    {season.status}
                  </Badge>
                </div>
              </div>
