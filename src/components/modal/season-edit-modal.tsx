...
export default function SeasonEditModal({
  ...
  // Fetch categories when modal opens - DISABLED FOR NOW
  // useEffect(() => {
  ...
  const handleUpdateSeason = async (): Promise<void> => {
    ...
    try {
      ...
      // Send only the basic season data without categories for now
      const seasonData = {
        name: form.name,
      ...
      const response = await axiosInstance.put(
        endpoints.season.update(season.id),
        seasonData
      );
      ...
      <DialogContent className="sm:max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader className="space-y-3">
          ...
          <DialogDescription className="text-base">
            {currentStep === "form"
              ? "Update your season details and configuration."
              : "Review all changes before updating the season."}
          </DialogDescription>
        </DialogHeader>
        ...
        {currentStep === "form" && (
          <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
            ...
            {/* Category Selection - DISABLED FOR NOW */}
            {/* <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Select categories for this season (optional)
              </p>
            </div> */}
        ...
        <DialogFooter className="flex gap-3 pt-4">
          {currentStep === "form" ? (
            <>
              ...
              >
                <ArrowRight className="mr-2 h-4 w-4" /> Review Changes
              </Button>
            </>
          ) : (
            <>
              ...
              <Button onClick={handleUpdateSeason} disabled={loading}>
                {loading ? (
                  <>
                  ...
                  <>
                    <Trophy className="mr-2 h-4 w-4" /> Update Season
                  </>
                )}
              </Button>
            </>
