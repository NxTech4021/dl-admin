                              ...
                              {latestDivision ? (
                                <div className="space-y-1">
                                  <Link
                                    ...
                                    params={{ divisionId: latestDivision.id }}
                                    ...
                                    >
                                      ...
                                      <div className="flex items-center gap-3 flex-shrink-0">
                                        {season.division && (
                                          <Link
                                            to="/divisions/$divisionId"
                                            params={{ divisionId: season.division.id }}
                            ...
                            >
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="text-xs text-muted-foreground mt-0.5 pl-4">
                                  ...
                                  {season.seasonEndDate && ` — ${formatShortDate(season.seasonEndDate)}`}
                                  {season.division && (
                                    <> · <Link to="/divisions/$divisionId" params={{ divisionId: season.division.id }} className="hover:text-primary">{season.division.name}</Link></>
                                  )}
                                </div>
                              </div>
