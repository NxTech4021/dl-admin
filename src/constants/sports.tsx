  ...
  >
    <g>
      <g fill="#6B21A8">
        ...
        />
        <path
          d="M43.626 19.984c-.384 0-.768-.146-1.06-.44l-4.11-4.11a1.5 1.5 0 1 1 2.12-2.12l4.11 4.11a1.5 1.5 0 0 1-1.06 2.56zM48.026 15.585c-.383 0-.767-.147-1.06-.44l-4.11-4.11a1.5 1.5 0 1 1 2.12-2.121l4.11 4.11a1.5 1.5 0 0 1-1.06 2.561z"
          fill="#6B21A8"
          opacity="1"
        />
      </g>
...
export const getSportIcon = (sportType: string | null | undefined, size = 18) => {
